...
Public Class domisili_sudah_tidak_berdomisili_
    Sub reset()
        TextBox1.Text = ""
        TextBox2.Text = ""
        TextBox3.Text = ""
    ...
    Sub word()
        ...
        ObjDocWord = ObjAppWord.Documents.Open("D:\APP\Document\keterangan domisili sudah tidak berdomisili.docx")
        ...
        ObjDocWord.Bookmarks("keperluan_surat").Select()
        ObjAppWord.Selection.TypeText(TextBox4.Text)
        ObjDocWord.Bookmarks("alamat_tujuan").Select()
        ...
        namafile = "D:\APP\NewDocument\keterangan domisili sudah tidak berdomisili\" & TextBox2.Text & "-" & DateTimePicker2.Text & ".docx"
